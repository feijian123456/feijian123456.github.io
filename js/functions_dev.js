...
$(function () {
	...
	$loveHeart = $("#loveHeart");
	if (clientWidth <= 720) {
		$loveHeart.css('width', clientWidth * 0.9);
		$loveHeart.css('height', clientWidth * 0.9 * 625 / 670);
	}
	...
	if (clientWidth <= 720) {
		...
		$("#content").css("margin-left", ($window.width() - $("#content").width()) / 2);
	} else {
...
function adjustWordsPosition() {
	...
	if ($(window).width() <= 720) {
		$('#words').css("top", $("#garden").position().top + $("#loveHeart").height());
		$('#words').css("left", 0);
	} else {
